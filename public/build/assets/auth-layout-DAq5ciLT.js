import{j as e}from"./ui-B8HeZKV4.js";import{X as n,x as c}from"./app-C5HTC3DJ.js";import{L as m,u as x}from"./useFlashMessages-qzZkU2cw.js";import{a as g,u as p,B as b}from"./use-favicon-Yu0h-q0L.js";import{j as h}from"./helpers-CMqaUKac.js";import{C as u}from"./cookie-consent-DtuirxS9.js";function j({children:s,title:t,description:o}){const{settings:a,getPrimaryColor:i}=g(),{adminAllSetting:d}=n().props;p();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,r=i();return e.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[e.jsx("style",{children:`
                .bg-primary {
