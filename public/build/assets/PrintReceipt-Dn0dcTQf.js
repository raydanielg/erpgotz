import{a as x,f as o}from"./helpers-BKheTV-y.js";import"./app-esgSRRgv.js";import"./ui-B8HeZKV4.js";const h=(a,i)=>{var s,p,d,r;const f=`
    <!DOCTYPE html>
    <html>
    <head>
    ...
    `,n=document.createElement("iframe");n.style.display="none",document.body.appendChild(n);const e=n.contentDocument||((p=n.contentWindow)==null?void 0:p.document);e&&(e.write(f),e.close(),(d=n.contentWindow)==null||d.focus(),(r=n.contentWindow)==null||r.print(),setTimeout(()=>{document.body.removeChild(n)},1e3))};export{h as printReceipt};
